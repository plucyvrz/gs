...
import time, datetime, random, sys, json, codecs, threading, glob, re, string, os, requests, html5lib, subprocess, urllib, urllib2, urllib3, wikipedia, ast

cl = LINEBALI.LINE()
#cl.login(qr=True)
cl.login(token='EoiAlGUPtEI2JHVKADva.6n/5nCr1iFrpVM/keiA0cG.frQleZ/i8fgRuTzDnsOJZ9fK2dhiIkrCNjRFOSRSn5I=')
cl.loginResult()
...
blacklist ="""─┅༅ই Bʟᴀᴄᴋʟɪsᴛ Cᴏᴍᴍᴀɴᴅ ই༅┅─
╌╍════════════════╍╌
🎱 Bᴀɴ                                         ﹫
🎱 Uɴʙᴀɴ                                    ﹫
🎱 Cʟᴇᴀʀ ʙᴀɴ                             ﹫
...
spam ="""     ─┅༅ই Sᴩᴀᴍ Cᴏᴍᴍᴀɴᴅ ই༅┅─
╌╍════════════════╍╌
📣Sᴩᴀᴍ   ᴏɴ/ᴏғғ   ᴊᴜᴍʟᴀʜ   ᴛᴇxᴛ
📣Spamtag                                ﹫
📣Sᴩᴀᴍ ᴀᴅᴅ:
📣Sᴩᴀᴍ:
📣Sᴩᴀᴍ﹖
...
translateMessage ="""    ─┅༅ই Tʀᴀɴsʟᴇᴛᴇ Hᴇʟᴩ ই༅┅─
╌╍════════════════╍╌
💻Tʀ-ɪᴅ ﹦ Iɴᴅᴏɴᴇsɪᴀ
💻Tʀ-ᴊᴀ ﹦ Jᴇᴩᴀɴɢ
💻Tʀ-ᴇɴ ﹦ Iɴɢɢʀɪs
...
#--------------------------------------------------------
              ...
              if wait["tag"] == True:
                ...
                resp = ("《《AUTO RESPON》》\n")
                jawab = ("Penting pc aja kak","Jangan tag gua, Brisik!","Bhaks, ada apa ya")
...
#---------------------------------------------------------
            ...
            elif msg.text in ["Autorespon:on","Respon on","Respon:on"]:
                wait["detectMention"] = True
                cl.sendText(msg.to,"Auto respon tag On")
                
            elif msg.text in ["Autorespon:off","Respon off","Respon:off"]:
...
#--------------------------------------------------------
                ...
                try:
                    ...
                    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto Like by me")
...
#---------------------------------------------------------
                    ...
                    h = cl.getContact(mid)
                    cl.sendText(msg.to,"╌╍══Dɪsᴩʟᴀʏ Nᴀᴍᴇ══╍╌[\n" + h.displayName)
            elif msg.text in ["Mybio"]:
                    h = cl.getContact(mid)
                    cl.sendText(msg.to,"╌╍══Sᴛᴀᴛᴜs Mᴇssᴀɢᴇ══╍╌\n" + h.statusMessage)
...
#-------------------------------------------
                ...
                day = ["Sᴜɴᴅᴀʏ", "Mᴏɴᴅᴀʏ", "Tᴜᴇsᴅᴀʏ", "Wᴇᴅɴᴇsᴅᴀʏ", "Tʜᴜʀsᴅᴀʏ","Fʀɪᴅᴀʏ", "Sᴀᴛᴜʀᴅᴀʏ"]
                hari = ["Mɪɴɢɢᴜ", "Sᴇɴɪɴ", "Sᴇʟᴀsᴀ", "Rᴀʙᴜ", "Kᴀᴍɪs", "Jᴜᴍᴀᴛ", "Sᴀʙᴛᴜ"]
                bulan = ["Jᴀɴᴜᴀʀɪ", "Fᴇʙʀᴜᴀʀɪ", "Mᴀʀᴇᴛ", "Aᴩʀɪʟ", "Mᴇɪ", "Jᴜɴɪ", "Jᴜʟɪ", "Aɢᴜsᴛᴜs", "Sᴇᴩᴛᴇᴍʙᴇʀ", "Oᴋᴛᴏʙᴇʀ", "Nᴏᴠᴇᴍʙᴇʀ", "Dᴇsᴇᴍʙᴇʀ"]
...
#--------------------------------------------------------
                ...
                try:
                    ...
                    user = "Nᴀᴍᴇ: " + text[-2] + "\n"
                    user1 = "Usᴇʀɴᴀᴍᴇ: " + text[-1] + "\n"
                    followers = "Fᴏʟʟᴏᴡᴇʀs: " + text[0] + "\n"
                    following = "Fᴏʟʟᴏᴡɪɴɢs: " + text[2] + "\n"
                    post = "Pᴏsᴛ: " + text[4] + "\n"
                    link = "Lɪɴᴋ: " + "https://www.instagram.com/" + instagram
                    detail = "╌╍═══════Iɴsᴛᴀɢʀᴀᴍ Iɴғᴏ Usᴇʀ═══════╍╌\n"
                    details = "\╌╍═══════Iɴsᴛᴀɢʀᴀᴍ Iɴғᴏ Usᴇʀ═══════╍╌"
...
#-----------------------------------------------------------
                ...
                wait["spam"] = msg.text.replace("Set spam: ","")
